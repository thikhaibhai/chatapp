...
# pip install streamlit sentence-transformers PyMuPDF langchain numpy google-generativeai python-dotenv pillow
# ==============================
...
# Load API Key
# ==============================
load_dotenv("env.env")  # make sure env.env is present
GOOGLE_API_KEY = os.getenv('GOOGLE_API_KEY')
if not GOOGLE_API_KEY:
    st.error("Please set the GOOGLE_API_KEY in env.env")
else:
